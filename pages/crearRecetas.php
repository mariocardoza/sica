                  ...
                  <div class="panel-body">
                    <div class="col-md-12" >
                        ...
                        <p class="animated fadeInDown">
                          Receta <span class="fa-angle-right fa"></span>Datos de la receta
                        </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                          ...
                          <div class="col-md-6">
                           ...
                           <input id="nombrer" type="text" class="form-control" name="nombrer"  placeholder="Nombre" onkeypress="return sololetras(event)">
                           </div>
                           </br>
                           </br>
...
if ($bandera == "add") {
  ...
  $consulta  = "INSERT INTO recetas (nombre) VALUES('" .$receta. "')";
    $resultado = $conexion->query($consulta);
    if ($resultado) {
        
        //Finde bloque.
        msgAdd("Se registró la receta.");
