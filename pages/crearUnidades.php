                ...
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12" >
                         ...
                         <h3 class="animated fadeInLeft">Unidad de Medida</h3>
                        <p class="animated fadeInDown">
                          Unidad <span class="fa-angle-right fa"></span>Datos del registro
                        </p>
                    </div>
                  </div>
                </div>
...
if ($bandera == "add") {
  ...
  $consulta  = "INSERT INTO unidad_medidas (nombre_unidad) VALUES('" .$unidad_medida. "')";
    $resultado = $conexion->query($consulta);
    if ($resultado) {
        
        //Finde bloque.
        msgAdd("Unidad registrada");
